    ...
    <section className="p-6 bg-slate-50 rounded-lg">
      ...
      <Accordion type="single" collapsible className="w-full max-w-3xl mx-auto">
        ...
        <AccordionItem value="faq-1">
          <AccordionTrigger>How do I register comprehensive job portal?</AccordionTrigger>
          <AccordionContent>
        ...
        <AccordionItem value="faq-4">
          ...
          <AccordionContent>
            Yes, This is free for job seekers. Employers may have premium plans for enhanced visibility of their job postings.But for now it's free to all 
          </AccordionContent>
        </AccordionItem>
        ...
        <AccordionItem value="faq-5">
          ...
          <AccordionContent>
            Please contact our support team via the "Help" section in your dashboard or email us at kireetisangala@gmail.com.
          </AccordionContent>
        </AccordionItem>
      </Accordion>
    </section>
